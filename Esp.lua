...
local ESP = {
    ...
    Drawing = {
        Chams = {
            Enabled  = true,
            Thermal = true,
            FillRGB = Color3.fromRGB(170, 20, 255),
            Fill_Transparency = 100,
            OutlineRGB = Color3.fromRGB(170, 20, 255),
        ...
        Healthbar = {
            Enabled = true,  
            HealthText = true, Lerp = false, HealthTextRGB = Color3.fromRGB(255, 0, 0),
            Width = 2.5,
            Gradient = true, GradientRGB1 = Color3.fromRGB(200, 0, 0), GradientRGB2 = Color3.fromRGB(100, 100, 0), GradientRGB3 = Color3.fromRGB(0, 200, 0), 
        },
        Boxes = {
            Animate = true,
            RotationSpeed = 300,
            Gradient = false, GradientRGB1 = Color3.fromRGB(10, 10, 10), GradientRGB2 = Color3.fromRGB(0, 0, 0), 
