...
makemarker(placemarker, placemarker, Color3.fromRGB(10, 10, 10), 0.8, 0)
            ...
            Script.Functions.VisualizeMovement = function()
                if Settings.Combat.Skibidi then
                  ...
                  local Ball = Instance.new('Part') do
                      ...
                      Ball.Color = Color3.fromRGB(10, 10, 10)
...
local window = library:Window({Name = [[Affinity <font color="rgb(10, 10, 10)">.lua</font>]], Size = Vector2.new(450,450)});
    ...
    elseif ping < 30 then
        ...
        local wrldstff = looking:Section({Name = "Environment", Side = "Left", Size = 340})
            do
                ...
                end}):Colorpicker({Name = "color", Default = Color3.fromRGB(10, 10, 10), Callback = function(v)
...
local Settings = {
    Visuals = {
        SelfESP = {
            Trail = {
                InsideColor = Color3.fromRGB(10, 10, 10),
                OutsideColor = Color3.fromRGB(10, 10, 10),
                LifeTime = 5,
                Width = 0.08
            }
        }
