...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/RewritingScripter1/Files-Of-Script/refs/heads/main/My-Ui-LibraryNew.lua"))() --you can go into the github link and copy all of it and modify it for yourself.
...
local Window3 = Library:CreateWindow("Skiddedliar.cc", Vector2.new(430, 310))
...
local fortnite =
    ...
    function(bool)
        ...
        NotifyLib.prompt("Skiddedliars", "Successfully copied to clipboard", 3)
    end
)
...
loadscreen3:AddButton(
    ...
    function()
        if checkifexecuted == true then
            NotifyLib.prompt("Skiddedliars", "Already Executed!", 0)
            return
        end
        if checkifanticheat == false then
            if game.PlaceId == 2788229376 then
                if anticheatbypass == "Anticheat" then
                    ...
                    NotifyLib.prompt("Skiddedliars", "Bypassed Anti Cheat! (Da hood Bypass Version)", 0)
                end
                ...
                if checkifanticheat == false then
                    if game.PlaceId == 5602055394 then
                        if anticheatbypass == "Anticheat" then
                            ...
                            NotifyLib.prompt("Skiddedliars", "Bypassed Anti Cheat! SEMI (Hood Modded Bypass Version)", 0)
                        end
                    end
                end
            end
        ...
        if checkifanticheat == false then
            if game.PlaceId == 9183932460 then
                if anticheatbypass == "Anticheat" then
                    ...
                    NotifyLib.prompt("Skiddedliars", "Bypassed Anti Cheat! (Untilted hood Bypass Version)", 0)
                end
            end
        end
        ...
        if versionthing == "Private" then --Memelouse#3150
            ...
            --Memelouse#3150
            Library.theme.accentcolor = Color3.fromRGB(100, 100, 100)
            local watermark = Library:CreateWatermark("Skiddedliars | v2.19 | {fps} | {game} ")
            local Window = Library:CreateWindow("Skiddedliars", Vector2.new(430, 310), Enum.KeyCode.RightControl)
            ...
            if locksectionenabled then
                ...
                local LockButton = Anti:CreateSector("Lock Button" "left") 
                
                testSection:AddButton("Camlock 1 <Heads>", function(FuckGayPeople)
                local gui = Instance.new("ScreenGui")
gui.Name = "Dukeshadow"
gui.Parent = game.CoreGui
local TextButton = Instance.new("TextButton")
TextButton.Text = "Skidded.lol"
...
TextButton.MouseButton1Click:Connect(function()
                        ...
                        if Aimlock and AimlockTarget == nil then
                            ...
                            if Target ~= nil then
                                ...
                                if getgenv().Notificationmode and getgenv().Notificationmodepart == "Meff" then
                                    NotifyLib.prompt("Skiddedliars", "Locked: " .. AimlockTarget.DisplayName, 0)
                                end
                            end
                        else
                            ...
                            if MousePressed ~= false then
                                ...
                                if getgenv().Notificationmode and getgenv().Notificationmodepart == "Meff" then
                                    NotifyLib.prompt("Skiddedliars", "Unlocked", 0)
                                end
                                Line2.Visible = false
                            end
                        end
                            ...
                            if aiming.targetaim.enabled then
                                ...
                                if aiming.targetaim.targeting then
                                    ...
                                    if
                                     ...
                                     then
                                        NotifyLib.prompt("Skiddedliars", "Locked: " .. tostring(targetplr), 0)
                                    end
                ...
                local enablevelo =
                    ...
                    function(Boolean)
                        ...
                        if velocitywalk == true and notifyvel == true and Notificationstype2 == "Meff" then
                            NotifyLib.prompt("Skiddedliars", "Enabled", 0.5)
                        end
                        if velocitywalk == false and notifyvel == true and Notificationstype2 == "Meff" then
                            NotifyLib.prompt("Skiddedliars", "Disabled", 0.5)
                        end
            ...
            if miscenabled then
                ...
                fard5:AddButton(
                    ...
                    function()
                        ...
                        NotifyLib.prompt("Skiddedliars", "Succes!", 3)
                    end
                )
            ...
            if is_synapse_function then
                ...
                NotifyLib.prompt("Skiddedliars", "Your Executor Doesnt Support Config.", 3)
            end
            ...
            NotifyLib.prompt("Skiddedliars", "Successfully Loaded Script!", 3)
        end
    end
)
